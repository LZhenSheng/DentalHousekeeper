...
import com.example.dentalhousekeeper.adapter.PreOrderAdapter;
...
public class PreOrderPatientActivity extends BaseTitleActivity {

    @BindView(R.id.rv)
    RecyclerView rv;

    PreOrderDoctorAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pre_order_patient);
    }
...
//        initStatusBar();
        ...
        //设置布局管理器
        LinearLayoutManager layoutManager = new LinearLayoutManager(PreOrderPatientActivity.this);
        rv.setLayoutManager(layoutManager);
        adapter = new PreOrderDoctorAdapter(R.layout.item_preorder);
            ...
            public void onItemChildClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                switch (view.getId()){
                    case R.id.into:
                        ...
                        Intent intent=new Intent(PreOrderPatientActivity.this, JoinRoomActivity.class);
    ...
    private void fetchData() {
        ...
        Api.getInstance().findAppointmentByPatientId(patient)
