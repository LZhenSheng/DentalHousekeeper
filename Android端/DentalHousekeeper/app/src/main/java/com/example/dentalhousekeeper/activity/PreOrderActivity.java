...
public class PreOrderActivity extends BaseTitleActivity {
    ...
    public void initData() {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(PreOrderActivity.this);
            ...
            public void onItemChildClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                switch (view.getId()) {
                    case R.id.into:
                        ...
                        Intent intent = new Intent(PreOrderActivity.this, CreateRoomActivity.class);
