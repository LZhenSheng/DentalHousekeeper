...
public class MessageDoctorActivity extends BaseTitleActivity implements OnNumberPickedListener, OnDatePickedListener {
    ...
    @OnClick({R.id.age_container,R.id.birthday_container,R.id.avatar_container,R.id.gender_container, R.id.area_container, R.id.save})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.area_container:
                ...
                break;
            case R.id.save:
                Doctor doctor = new Doctor(PreferenceUtil.getId(), getContent(etNickname),tvGender.getText().toString().equals("男")?1:0,
                        provinceName,cityName,areaName,Integer.valueOf(tv_age.getText().toString()),tv_birthday.getText().toString(),avatar,e_mail.getText().toString(),et_description.getText().toString());
                Api.getInstance()
                        .updateMessage(doctor)
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                case PictureConfig.CHOOSE_REQUEST:
                    ...
                    avatar= String.valueOf(UUID.randomUUID()+".")+picPath;
